		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"rgba(110,22,64,0)","borderStyle":"solid"}'>
				<div class="box" style='width:1100px'>
					  ...
					  <span>DATA SHOW</span><span>汽车信息展示</span>
					</div>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(212, 173, 140, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"2px","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(74, 74, 74, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>汽车名称</div>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(74, 74, 74, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>汽车品牌</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 0 0 -50px","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"95px","borderStyle":"solid","height":"auto"}'>
			...
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;box-sizing: border-box;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(157, 126, 98, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
							...
							<div @click="jump('../qichexinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='1'?'list-item1':3=='3'?'list-item3':''">
								<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px","borderColor":"rgba(223, 223, 223, 1)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"0","borderWidth":"0 5px 0 0 ","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(255, 255, 255, 0.97)","borderRadius":"0","borderWidth":"10px","width":"180px","borderStyle":"solid","height":"180px"}' :src="item.qichetupian?baseurl+item.qichetupian.split(',')[0]:''">
									<div class="item-info">
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"14px"}' class="name">{{item.qichemingcheng}}</div>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/qicheleixing/qicheleixing`,'get',{},(res)=>{
                			vue.qicheleixingOptions = res.data
        			});
			        vue.tianchuangOptions = '有天窗,没天窗'.split(',')
			        vue.huandangfangshiOptions = '手动挡,自动挡'.split(',')
			        vue.zuoweiOptions = '2座,4座,5座,7座,其他'.split(',')
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/qicheleixing/qicheleixing', 'get', {}, function(res) {
