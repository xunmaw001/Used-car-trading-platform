...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<button class="btn-upload" id="hetongneirong">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>生效日期</label>

									<input id="shengxiaoriqi" name="shengxiaoriqi" class="form-control" v-model="ruleForm.shengxiaoriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>签订日期</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var hetongneirongUrl = "download('" + ruleForm.hetongneirong + "')";
			$("#hetongneirong").attr("onclick",hetongneirongUrl);
		}			
		//设置音视频播放链接
