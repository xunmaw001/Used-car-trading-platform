...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑汽车下单</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>汽车下单管理</span></li>
								<li class="breadcrumb-item active"><span>编辑汽车下单</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">汽车下单信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>下单编号</label>
										<input id="xiadanbianhao" name="xiadanbianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>汽车名称</label>
									...
									<div class="form-group col-md-6">
										...
										<div id="xiadanshijianDate" class="input-append date form_datetime">
											<input id="xiadanshijian-input" name="xiadanshijian" size="15" type="text" readonly>
	...
	<script>
		...
		function xiadanbianhaoUuid(){
			if($("#xiadanbianhao").val() == null || $("#xiadanbianhao").val() == "null" || $("#xiadanbianhao").val() == ""){
				$("#xiadanbianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qichexiadan/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("qichexiadan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("qichexiadan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("qichexiadan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#xiadanbianhao").val(ruleForm.xiadanbianhao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xiadanbianhao != null && res.data.xiadanbianhao != ''){

						$("#xiadanbianhao").val(res.data.xiadanbianhao);
						$("#xiadanbianhao").attr('readonly','readonly');
					}
