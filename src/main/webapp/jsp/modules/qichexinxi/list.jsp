...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('qichebianhao')">汽车编号<i id="qichebianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var qichebianhaoCell  = document.createElement('td');

						 qichebianhaoCell.innerHTML = item.qichebianhao;

			row.appendChild(qichebianhaoCell);
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'qichexiadan','','','')");
	...
	function discussList(id) {
            ...
            window.location.href = "../discussqichexinxi/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
